======================
README for learn_linux
======================

This section is all about using the Linux command line, or terminal. If you can,
it would be helpful to open these files in a text editor in one window and a
command line in another window so you can try out the commands and tips as you
read about them.
...
to navigate in the Linux command line.
...
In general, Linux commands only produce output when the user asks for it (e.g.
